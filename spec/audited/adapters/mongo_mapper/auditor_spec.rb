...
describe Audited::Auditor, adapter: :mongo_mapper do
  ...
  describe "configuration" do
    ...
    it "should not save non-audited columns" do
      Models::MongoMapper::User.non_audited_columns = (Models::MongoMapper::User.non_audited_columns << :favourite_device)

      expect(create_mongo_user.audits.first.audited_changes.keys.any? { |col| ['favourite_device', 'created_at', 'updated_at', 'password'].include?( col ) }).to eq(false)
    end
